...
#define HTTP_MESSAGE_SIZE  1000
#define HTTP_POST_SIZE  2200

//extern void APISelect(void *data);
extern void buddy_msg_callback ( struct qqclient* qq, uint uid, time_t t, char* msg );
extern void qun_msg_callback ( struct qqclient* qq, uint uid, uint int_uid, time_t t, char* msg );
extern void buddy_sign_callback( struct qqclient* qq, uint uid, time_t t, char* msg);
